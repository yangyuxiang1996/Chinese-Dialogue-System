...
'''
Author: yangyuxiang
Date: 2021-06-16 20:31:46
LastEditors: yangyuxiang
LastEditTime: 2021-06-16 20:32:55
FilePath: /Chinese-Dialogue-System/generative/config_distil.py
Description:
'''
...
def parse(opt=None):
    ...
    parser.add_argument(
        "--output_dir",
        default=os.path.join(Config.root_path, 'model/generative'),
        type=str,
        help="The output directory where the model checkpoints will be written."
    )
    parser.add_argument(
        "--log_file",
        default=os.path.join(Config.root_path, 'log/distil.log'),
        type=str,
        help="The output directory where the model checkpoints will be written."
    )
    # Other parameters
    ...
    parser.add_argument("--test_path",
                        default=os.path.join(
                            Config.root_path, 'data/generative/test.tsv'),
                        type=str)
    parser.add_argument(
        "--do_lower_case",
        default=True,
    ...
    parser.add_argument('--tuned_checkpoint_T',
                        type=str,
                        default=os.path.join(Config.root_path, 'model/generative/bert.model.epoch.29'))
    parser.add_argument('--tuned_checkpoint_S', type=str, default=None)
    parser.add_argument("--init_checkpoint_S",
                        default=os.path.join(Config.root_path,
